...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/about.png" alt="Image">
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">Rabee
                    Renatl</span></h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="img/about.png" alt="">
                    <p>Welcome to <span class="text-primary">Rabee Rental</span>, your ultimate destination for
                        hassle-free car rentals!

                        At <span class="text-primary">Rabee Rental</span>, we understand the importance of convenience
                        and reliability
                        when it comes to renting a car. Whether you're planning a weekend getaway, a business trip, or
                        simply need a temporary replacement vehicle, we've got you covered.

                        With a wide range of vehicles to choose from, including sedans, SUVs, trucks, and more, we cater
                        to all your transportation needs. Our fleet is well-maintained, modern, and equipped with the
                        latest features to ensure a comfortable and enjoyable driving experience.

                        Booking with us is easy and seamless. Simply browse through our selection of vehicles, select
                        your preferred car, choose your rental dates, and make a reservation - it's that simple! Plus,
                        with flexible rental options and competitive pricing, you can find the perfect vehicle at the
                        best price to suit your budget.

                        Our dedicated team of professionals is committed to providing exceptional customer service every
                        step of the way. Whether you have questions about our rental process, need assistance with your
                        booking, or require support during your rental period, we're here to help.

                        At <span class="text-primary">Rabee Rental</span>, your satisfaction is our top priority.
                        Experience the
                        convenience, reliability, and affordability of renting a car with us today!</p>
                </div>
            </div>
            <!-- <div class="row mt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="rent-item">
                            ...
                            @endphp
                            @if($firstImage)
                            <img class="img-fluid mb-4" src="{{ asset('storage/'.$firstImage) }}" alt="">
                            @endif
                            ...
                            <a class="btn btn-primary px-3" href="">Details</a>
                        </div>
                    </div>
                    @endforeach
                </div>
